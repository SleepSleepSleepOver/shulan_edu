...
class _VideoDetailPageState extends State<VideoDetailPage> with AutomaticKeepAliveClientMixin  , SingleTickerProviderStateMixin{
    ...
    return Scaffold(
      ...
      body: AnnotatedRegion<SystemUiOverlayStyle>(
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              margin: EdgeInsets.only(left: 15.px,top: 19.px),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
            ...
            WLine(marginLeft: 15.px,marginRight: 15.px,color: Mcolors.CF2F2F2,height: 1.px,marginTop: 20.px,),
            Container(
